...
function UserReviews() {
  ...
  useEffect(() => {
    fetch(`https://cors-anywhere.herokuapp.com/http://cinemate-env.eba-xuvrv233.us-east-1.elasticbeanstalk.com/reviews/userId?userId=${userId}`)
      .then(res => res.json())
      .then(data => {
        console.log(data);
  ...
  const handleSubmit = async (e) =>{
    e.preventDefault()
    fetch(`https://cors-anywhere.herokuapp.com/http://cinemate-env.eba-xuvrv233.us-east-1.elasticbeanstalk.com/reviews/delete/reviewId?reviewId=${e.target.id}`, {
      method: 'DELETE',
